...
boss_dialog_pages = [
    { speaker: "CHILL PENGUIN", mugshot: spr_chill_talk, mugshot_idle: spr_chill_look, text: "So you've come this far...", is_boss: true },
    { speaker: _p.speaker, mugshot: _p.mugshot, mugshot_idle: _p.mugshot_idle, text: "Chill Penguin! Your Maverick rampage ends here!", is_boss: false },
];